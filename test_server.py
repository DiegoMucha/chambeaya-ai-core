...
estudiante_prueba = Estudiante(
    career="Ingeniería",
    habilidades_destacadas="Python, Machine Learning",
    areas_interes="Desarrollo de Software, Inteligencia Artificial",
    descripcion_personal="Apasionado por la tecnología y el aprendizaje automático.",
    experiencia_relevante="Desarrollador de software con 3 años de experiencia en Python y JavaScript.",
...
def test_match():
    ...
    X_estudiantes, X_puestos = preprocesador.fit_transform(df_estudiante, df_puestos)
    ...
    distances, indexes = model.get_positions(X_estudiante)
    return {
